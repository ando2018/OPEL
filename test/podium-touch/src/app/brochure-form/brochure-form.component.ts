...
import { environment } from '../../../../car-data-stand/src/environments/environment';
    ...
    ngOnInit() {
        this.sharedService.getBrochure().subscribe((v: Vehicle) => {
            if (!v) {
                ...
                this.qrCodeSrc =  `${environment.appBaseUrl}/podium/analytics-pdf/${this.vehicle.brochureName}/${btoa(pdfUrl)}`;
            }
        });
